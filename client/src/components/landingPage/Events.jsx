  ...
  return (
    <div className="w-full flex flex-col items-center gap-12">
      ...
      <p className="text-md text-white mx-auto text-center mt-3 w-[70%]">
          ...
          community that possesses a wealth of knowledge and experience. Dive
          deep into conversations, learn from experts, and discover the secrets
          of wealth creation. Join a supportive community that will keep you
